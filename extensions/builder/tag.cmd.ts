...
import { tagAction, tagAllAction } from 'bit-bin/api/consumer';
import { TagResults, NOTHING_TO_TAG_MSG, AUTO_TAGGED_MSG } from 'bit-bin/api/consumer/lib/tag';
import { isString } from 'bit-bin/utils';
