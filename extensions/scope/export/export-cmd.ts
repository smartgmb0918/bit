...
import { exportAction } from 'bit-bin/api/consumer';
import { BitId } from 'bit-bin/bit-id';
import { BASE_DOCS_DOMAIN, WILDCARD_HELP, CURRENT_UPSTREAM } from 'bit-bin/constants';
import { EjectResults } from 'bit-bin/consumer/component-ops/eject-components';
import ejectTemplate from 'bit-bin/cli/templates/eject-template';
