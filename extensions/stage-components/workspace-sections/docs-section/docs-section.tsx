...
import { LabelList } from 'bit-bin/workspace-components/label';
import { Separator } from 'bit-bin/workspace-components/separator';
import { VersionTag } from 'bit-bin/workspace-components/version-tag';
import styles from './docs-section.module.scss';
import { InstallMethods, InstallMethodsData } from 'bit-bin/workspace-components/install-methods';
